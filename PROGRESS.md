...
- 创建并验证 `v1.0.0` 正式 tag、生产镜像和 GitHub Release。

## 阶段状态

P6、P7 均已由项目所有者验收通过。P8 的测试、演示数据、版本信息、README、架构、安全、排错、简历、截图和发布清单已经完成；提交 `0b90aa5` 的 GitHub CI 全部绿色，仓库已在秘密检查后公开。项目所有者明确不进行完整 24 小时观察，现有整机重启、健康检查、HTTPS、备份恢复、回滚、公网 Agent 缓存补传和实时上报证据作为 P7 稳定性验收依据，不声称已完成 24 小时稳定性测试。
