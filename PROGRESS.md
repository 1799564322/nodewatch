...
P6 已由项目所有者验收通过。P7 已完成阿里云 IP/HTTP 部署、备份恢复和重启验收；因暂无域名，ICP 备案、HTTPS 与公网 Agent 验收待办，尚不进入 P8。
...
- P7 待办：当前没有域名，无法完成 ICP 备案、受信任 HTTPS 和公网 Agent 安全上报；公网 HTTP 仅作临时功能验证。
